...
class ShellTask extends BaseTask {
  ...
  async execute(colors) {
    const { workingDirectory, paths, cacheDirectory, options, config } = this.context
    ...
    for (const [index, project] of projects.entries()) {
      const info = Object.assign({ workingDirectory, cacheDirectory, scope, filters, npmLogLevel }, project)
